...
public class NodeDto implements Serializable {
    ...
    @Pattern(regexp = "^(?:[0-9]+[Dd])?[0-9]{2}:[0-9]{2}:[0-9]{2}(?:\\.[0-9]+)?$")
    ...
    private final static long serialVersionUID = 5741847585194105683L;
     ...
     * @param note
     */
    public NodeDto(String name, List<String> type, List<String> sW, String aggrWin, String note) {
        super();
        this.name = name;
        this.type = type;
        this.sW = sW;
